							...
							<c:forEach var="x"  items="${sessionScope.listap}">
								<tr>
									...
									<td>										
        								...
        								<a href="mostrarProfesor" ><button name="visualizar" value="<c:out value='${x.id}'/>" type="submit" formmethod="get" formaction="mostrarProfesor" class="btn btn-default btn-sm">
